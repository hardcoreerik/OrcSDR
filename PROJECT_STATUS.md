...
| FLARM EU AIR V6/V7 | **Implemented; host-tested** | Dual-channel 868.2/868.4 MHz CU8 decoder, shared ADS-B dashboard renderer, UTC/location gates, bounded aircraft tracking and sanitizer-tested independent packet/synthetic IQ fixtures. Native firmware build and live Tab5 RF/performance acceptance remain pending. See [FLARM receiver](docs/FLARM.md). |
