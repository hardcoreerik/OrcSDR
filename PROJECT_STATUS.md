...
| Screen ownership controller | **Implemented; build-verified** | `ScreenController` is the sole display-route owner for Home, FM, P25, ADS-B, LoRa, generic Radio/Scope/Capture, Settings, and documentation mode. Final on-device transition acceptance for the latest hardening remains pending. |
