...
constexpr ControlDescriptor kControls[] = {
    ...
    INT(View::spectrum, ControlGroup::quick, "fft.average_time_ms", "Average Time", 50, 5000, 50, 500),
    ...
    REAL(View::waterfall, ControlGroup::quick, "waterfall.gamma", "Contrast Curve", 0.4f, 2.5f, 0.05f, 1),
    ...
    REAL(View::spectrum3d, ControlGroup::quick, "spectrum3d.history_s", "History Time", 2, 60, 1, 20),
    ...
    CH(View::occupancy, ControlGroup::quick, "occupancy.threshold_mode", "Busy Threshold", "Absolute|Noise Relative|Adaptive", 1),
    ...
    ACT(View::occupancy, "occupancy.reset_session", "Reset Statistics"),
    ...
    ACT(View::peak_average, "peakavg.clear_hold", "Clear Max Hold"),
    ...
    ACT(View::doppler, "doppler.lock_track", "Lock Selected Track"),
    ...
    CH(View::channelizer, ControlGroup::quick, "channelizer.demod", "Selected Demod", "NFM|AM|USB|LSB|WFM", 0),
    REAL(View::channelizer, ControlGroup::quick, "channelizer.squelch_dbfs", "Selected Squelch", -120, -20, 1, -90),
    ...
    CAP(View::channelizer, ControlGroup::quick, ControlKind::toggle, "channelizer.solo", "Solo Selected", 0, 1, 1, 0, "Off|On", cap_channel_audio, false, "Audio limit reached for this quality profile"),
    CAP(View::channelizer, ControlGroup::quick, ControlKind::toggle, "channelizer.mute", "Mute Selected", 0, 1, 1, 0, "Off|On", cap_channel_audio, false, "Audio limit reached for this quality profile"),
