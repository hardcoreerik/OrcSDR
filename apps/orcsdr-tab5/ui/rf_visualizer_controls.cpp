...
constexpr ControlDescriptor kControls[] = {
    ...
    CH(View::spectrum3d, ControlGroup::quick, "spectrum3d.mesh_mode", "Render Mode", "Lines|Surface|Points", 1),
    CH(View::spectrum3d, ControlGroup::display, "spectrum3d.color_mode", "Color By", "Amplitude|Age|Hybrid", 2),
