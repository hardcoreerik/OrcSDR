...
ESP-IDF 5.5.4 must already be installed. The permanent C6 link has passed its
P4/C6 version-match and Wi-Fi-station acceptance. Use the explicit native build
steps in [the Tab5 ESP-Hosted 3.0.6 migration guide](docs/user-guide/tab5-esp-hosted-3-migration.md),
